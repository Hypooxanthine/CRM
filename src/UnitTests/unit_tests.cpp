...
void UnitTest::Test_Json()
{
    ...
    ContactManager cm;
    Contact c1 = (Contact("prenom1", "nom1", "entreprise1", "email1", "06 06 06 06 01", "photos/photo1.png", Date::today(), Date::today()));
    c1.setInteractionManager(im);
    cm.add(c1);
    Contact c2 = (Contact("prenom2", "nom2", "entreprise2", "email2", "06 06 06 06 02", "photos/photo2.png", Date::today(), Date::today()));
    c2.setInteractionManager(im);
    cm.add(c2);
    Contact c3 = (Contact("prenom3", "nom3", "entreprise3", "email3", "06 06 06 06 03", "photos/photo3.png", Date::today(), Date::today()));
    cm.add(c3);
